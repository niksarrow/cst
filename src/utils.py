...
def update_lambdas(params, n_total_iter):
    ...
    if params.lambda_xe_para_aux_config is not None:
                params.lambda_xe_para_aux = update_lambda_value(params.lambda_xe_para_aux_config, n_total_iter)
    if params.lambda_xe_mono_para_config is not None:
                params.lambda_xe_mono_para = update_lambda_value(params.lambda_xe_mono_para_config, n_total_iter)
